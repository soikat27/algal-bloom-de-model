...
\author{Soikat Saha\thanks{Corresponding author. \texttt{sahaso01@gettysburg.edu}} \\
        Shruti D.~Mishra \\
        \small Department of Mathematics, Gettysburg College, Gettysburg, PA, USA}
\date{July 2026}
...
This research was conducted under the supervision of Professor Cayce Fylling (Gettysburg College). Environmental observations and scenario data are drawn from Harwood~\cite{harwood-algae}. Code and supplementary materials are available at \url{https://github.com/soikat27/algal-bloom-de-model}.
